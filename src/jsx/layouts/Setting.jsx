		...
		<>
			<div className={`sidebar-right ${settingToggle ? "show" : ""}`}>
				...
				<div className="sidebar-right-inner">
					...
					<div className="note-text"><span className="text-danger">*Note :</span> This theme switcher is not part of product. It is only for demo. you will get all guideline in documentation. please check <a href="https://TrainingPlatform.Trigunasoftlab.com/react/doc" target="_blank" className="text-primary">documentation.</a></div>
				</div>
			</div>
